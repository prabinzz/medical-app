...
const Banner = (props: props) => {
  return (
    <div className="relative container mx-auto overflow-clip">
      <img
        className="absolute z-0  top-0 right-0 translate-x-32 -translate-y-12"
        src="img/bg_art2.svg"
      />
      <img
        className="absolute z-0 top-0 left-0 scale-150 -translate-x-8 translate-y-12"
        src="img/bg_art2.svg"
      />
      <img
        className="absolute z-0 top-0 right-[50%] translate-x-1/2 -translate-y-1/2"
        src="img/bg_art2.svg"
      />
      <div
